<?php
   ...
   if(isset($_POST['submit']))
   {
    ...
    for($a=0,$b=1,$c=2,$d=3,$e=4,$i=5,$g=6,$h=7;$a<=40,$b<=41,$c<=42,$d<=43,$e<=44,$i<=45,$g<=46,$h<=47;$a+=8,$b+=8,$c+=8,$d+=8,$e+=8,$i+=8,$g+=8,$h+=8){
        $sql="UPDATE $tablename set h1='$f[$a]', h2='$f[$b]',h3='$f[$c]',h4='$f[$d]',h5='$f[$e]',h6='$f[$i]',h7='$f[$g]',h8='$f[$h]' where day_='$days[$count]';";
        $conn->query($sql);
        $count++;
    }
   }
...
<header>
      <a href="index1.php"><div class="logo">MCE Portal</div></a>
        ...
        <nav class="nav-bar">
            <ul>
                <li>
                    <a href="adminviewlist.php">Home</a>
                </li>
                <li>
                    <a class="active" href="studttfetch.php">Schedule</a>
                </li>
                <li>
                    <a href="adminviewgrievance.php">Grievance</a>
                </li>
    ...
    <form action="admintt.php" method="post">
