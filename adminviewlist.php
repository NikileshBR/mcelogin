...
<body style="background-color:#ebeef1;">
    ...
    <header style="position:absolute; top:0px;">
        ...
        <nav class="nav-bar">
            <ul>
                <li>
                    <a href="adminviewlist.php" class="active">Classes</a>
                </li>
                <li>
                    <a href="admintt.php">Schedule</a>
                </li>
                <li>
                    <a href="">About</a>
                </li>
    ...
    <div style="text-align:center;  margin-top:300px; margin-left:auto; margin-right:auto; width:20%"></div>
    <a href='adminviewgrievance.php'>
